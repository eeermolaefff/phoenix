package com.phoenix.hermes.v1.service;

import com.phoenix.common.utils.Pair;
import com.phoenix.hermes.common.cycles.impl.interfaces.Cycle;
import com.phoenix.hermes.v1.cycles.processing.Arbitrageur;
import com.phoenix.hermes.v1.cycles.processing.ArbitrageFinder;
...
public class HermesService {
    ...
    private void launchArbitragesFromStartVertices(
        ...
        for (Pair<Integer, Boolean> pair : startVertices) {
            ...
            Pair<Arbitrageur, Set<Cycle>> result = ArbitrageFinder.findCycles(graph, startVertex);

            int componentId = connectivity.getComponentIdByVertex(startVertex);
            Arbitrageur arbitrage = result.getFirst();
