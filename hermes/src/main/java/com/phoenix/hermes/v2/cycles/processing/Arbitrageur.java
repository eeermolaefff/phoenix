package com.phoenix.hermes.v2.cycles.processing;
...
import com.phoenix.hermes.common.cycles.processing.Arbitrage;
...
public class Arbitrageur implements Arbitrage {
    ...
    public Arbitrageur(WeightedDigraph digraph, int startVertex) {
